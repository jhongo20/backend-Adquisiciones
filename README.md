...
![Logo de ADRES](assets/adres-logo.png)
...
Guía de instalación y configuración
1. Clonar el repositorio
bashCopiargit clone https://github.com/jhongo20/backend-Adquisiciones.git
cd backend-Adquisiciones
2. Restaurar paquetes NuGet
bashCopiardotnet restore
3. Instalar paquetes necesarios
Asegúrate de tener todos los paquetes de Entity Framework Core instalados:
bashCopiar# En el proyecto AdquisicionesApp.Data
...
jsonCopiar"ConnectionStrings": {
  "DefaultConnection": "Data Source=adquisiciones.db"
}
5. Compilar el proyecto
bashCopiardotnet build
6. Ejecutar migraciones (si es necesario)
Si no existe la base de datos, Entity Framework la creará automáticamente cuando ejecutes la aplicación gracias al método EnsureCreated() en el archivo Program.cs. Sin embargo, si deseas usar migraciones explícitas:
bashCopiarcd AdquisicionesApp.API
dotnet ef migrations add InitialCreate --project ../AdquisicionesApp.Data
...
bashCopiardotnet run

La API estará disponible en:

https://localhost:7138 (HTTPS)
...
Añadir soporte para carga de documentos
Implementar notificaciones por correo electrónico
Añadir pruebas unitarias y de integración
Implementar paginación en las consultas de grandes volúmenes de datos

Contacto
Para más información o soporte, contactar a:

Desarrollador: Jhon Guevara
GitHub: jhongo20
